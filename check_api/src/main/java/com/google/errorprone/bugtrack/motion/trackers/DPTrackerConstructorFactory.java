...
public final class DPTrackerConstructorFactory {
    ...
    public static DiagnosticPositionTrackerConstructor newTokenizedLineTracker() {
        return (srcFilePair, sharedState) -> new TokenizedLineTracker(
                TokenizedLine.tokenizeSrc(srcFilePair.oldFile.getLines(), sharedState.loadOldJavacContext(srcFilePair)),
                TokenizedLine.tokenizeSrc(srcFilePair.newFile.getLines(), sharedState.loadNewJavacContext(srcFilePair)));
    }
    ...
    public static DiagnosticPositionTrackerConstructor compose(DiagnosticPositionTrackerConstructor... trackerCtors) {
