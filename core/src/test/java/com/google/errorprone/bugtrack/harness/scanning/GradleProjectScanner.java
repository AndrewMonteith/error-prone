...
public class GradleProjectScanner extends ProjectScanner {
  ...
  private Path getSrcDirFromTaskname(CorpusProject project, String taskName) {
    // taskName will be of form :target1:...:targetK:compileJava or
    // :target1:...:targetK:compileTestJava
  ...
  private Optional<List<ProjectFile>> getFilesFromTaskName(
      CorpusProject project, String taskName, List<String> cmdArgs) {
    ...
    List<ProjectFile> filesToScan =
        FileUtils.findFilesMatchingGlob(projectSrcDir, "**/*.java").stream()
