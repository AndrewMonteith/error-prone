...
public class GradleProjectScannerTests {
  ...
  private static final CorpusProject GRADLE_TEST_PROJECT =
      new CorpusProject() {
        @Override
        public Path getRoot() {
          return Paths.get(
              "/home/monty/IdeaProjects/error-prone/core/src/test/java/com/google/errorprone/bugtrack/testdata/gradle_test_repo/");
        }
  ...
  @Test
  public void canTrackFilesEnteringProject()
      throws InterruptedException, GitAPIException, IOException {
    // GIVEN:
    CommitRange range =
        new CommitRange(
            "f7219b3c63679326d78f89258e9a2b7aac95385a", "450689a5eb2f880d87a3a6ba96de96177e9ad1a2");
    ...
    DiagnosticsScan firstDefaultCompile =
        Iterables.find(firstScans, scan -> scan.name.equals(":compileJava"));
    assertIsFiles(firstDefaultCompile, "App.java");

    DiagnosticsScan firstTestCompile =
        Iterables.find(firstScans, scan -> scan.name.equals(":compileTestJava"));
    ...
    DiagnosticsScan secondDefaultCompile =
        Iterables.find(secondScans, scan -> scan.name.equals(":compileJava"));
    assertIsFiles(secondDefaultCompile, "App.java", "File1.java", "File2.java", "File3.java");

    DiagnosticsScan secondTestCompile =
        Iterables.find(secondScans, scan -> scan.name.equals(":compileTestJava"));
  ...
  public void canTrackFilesLeaving() throws InterruptedException, GitAPIException, IOException {
    ...
    CommitRange range =
        new CommitRange(
            "450689a5eb2f880d87a3a6ba96de96177e9ad1a2", "6c5d496992a2544f44b64cc421f2a43c5b436a8e");
