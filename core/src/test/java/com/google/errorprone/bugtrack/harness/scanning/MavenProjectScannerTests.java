...
public class MavenProjectScannerTests {
    ...
    public void catchesFilesBeingAdded() throws IOException, InterruptedException, GitAPIException {
        // GIVEN:
        CommitRange range = new CommitRange("0c9d2b9520afab7501402ca7924a22c391ad9d8a", "05fe468e3e0c74a96057919c9262b0c8ccac2b5a");
        ...
        DiagnosticsScan firstDefaultCompile = Iterables.find(firstScans, scan -> scan.name.equals("default-compile my-app"));
        assertIsFiles(firstDefaultCompile, "App.java");

        DiagnosticsScan firstTestCompile = Iterables.find(firstScans, scan -> scan.name.equals("default-testCompile my-app"));
        ...
        DiagnosticsScan secondDefaultCompile = Iterables.find(secondScans, scan -> scan.name.equals("default-compile my-app"));
        assertIsFiles(secondDefaultCompile, "App.java", "Test1.java", "Test2.java");

        DiagnosticsScan secondTestCompile = Iterables.find(secondScans, scan -> scan.name.equals("default-testCompile my-app"));
    ...
    public void canDetectRenamingFiles() throws InterruptedException, GitAPIException, IOException {
        // GIVEN:
        CommitRange range = new CommitRange("05fe468e3e0c74a96057919c9262b0c8ccac2b5a", "816b2a9e0b350a07e4bedf85c638acec57ed0dee");
    ...
    @Test
    public void canDetectFilesChangesInMultipleTargets() throws InterruptedException, GitAPIException, IOException {
        // GIVEN:
        CommitRange range = new CommitRange("816b2a9e0b350a07e4bedf85c638acec57ed0dee", "d2b47d6405825929063ea852a3256842a227b29d");
