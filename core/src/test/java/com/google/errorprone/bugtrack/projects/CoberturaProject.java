...
import com.google.errorprone.bugtrack.harness.scanning.SourcepathScanner;
...
public final class CoberturaProject implements CorpusProject {
    @Override
    public Path getRoot() {
        return ProjectFiles.get("java-corpus/cobertura");
    }
