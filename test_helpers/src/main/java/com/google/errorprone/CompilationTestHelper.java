...
public class CompilationTestHelper {
    ...
    public CompilationTestHelper addSourceFile(Path p) {
        this.sources.add(fileManager.getJavaFileObject(p));
        return this;
    }
...
//
        ...
        return diagnosticHelper.getDiagnostics().stream().filter(isErrorProneDiagnostic).collect(Collectors.toList());
    }
